...
def stereoCalibrate(params, detectedCorners, cameraCalibrations):
    ...
    # get only the corners for the desired camera ids
    ...
    corners = corners[:, shuffledIdx[:numSamples], :, :]
    sampledFrameNumbers = detectedCorners.frameNumbers[cameraFlags][shuffledIdx[:numSamples]]
    ...
    for i in range(corners.shape[1]):
        ...
        writeStereoReprojection(
            ...
            sampledFrameNumbers[i], np.asarray(offsets)[cameraIds],
            cameraIds)
